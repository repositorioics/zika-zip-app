...
public class Infant07bVisitAdapter extends ArrayAdapter<String> {

	private final Context context;
	private final String[] values;
	private final List<Zp07bInfantAudioResults> mZp07b;
	...
	public Infant07bVisitAdapter(Context context, int textViewResourceId,
                                 String[] values, List<Zp07bInfantAudioResults> zp07b) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (!mZp07b.isEmpty()) {
			if (!changed){
				changed = true;
				for (Zp07bInfantAudioResults zp: mZp07b) {
