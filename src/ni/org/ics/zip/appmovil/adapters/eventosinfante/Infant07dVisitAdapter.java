...
public class Infant07dVisitAdapter extends ArrayAdapter<String> {

	private final Context context;
	private final String[] values;
	private final List<Zp07dInfantBayleyScales> mZp07d;
	...
	public Infant07dVisitAdapter(Context context, int textViewResourceId,
                                 String[] values, List<Zp07dInfantBayleyScales> zp07d) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (!mZp07d.isEmpty()) {
			if (!changed){
				changed = true;
				for (Zp07dInfantBayleyScales zp: mZp07d) {
