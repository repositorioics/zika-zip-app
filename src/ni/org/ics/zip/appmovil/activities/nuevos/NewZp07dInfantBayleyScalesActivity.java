...
import ni.org.ics.zip.appmovil.parsers.Zp07dInfantBayleyScalesXml;
        ...
        try {
            ...
            if (mInfantAssessment == null) {
                ...
                Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                        "jrFormId = 'ZP07d_Infant_Bayley_Scales' and displayName = 'Estudio Zip ESCALA DE BAYLEY DE DESARROLLO INFANTIL'", null, null);
                c.moveToFirst();
            ...
            try {
                ...
                try {
                    ...
                    if (accionaRealizar == ADD_ZP07_ODK){
                        zipA.crearZp07dInfantBayleyScales(mInfantAssessment);
                    }
                    else{
                        zipA.editarZp07dInfantBayleyScales(mInfantAssessment);
                    }
                    zipA.close();
                } catch (Exception e) {
