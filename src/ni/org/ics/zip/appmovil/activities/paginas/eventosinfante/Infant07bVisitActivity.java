...
import ni.org.ics.zip.appmovil.adapters.eventosinfante.Infant07bVisitAdapter;
...
public class Infant07bVisitActivity extends AbstractAsyncActivity {
	private ZipAdapter zipA;
	private static ZpInfantData zpInfante = new ZpInfantData();
	private static List<Zp07bInfantAudioResults> zp07b = null;
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				switch (position) {
					case 0: //RESULTADOS AUDIOLOGICOS
						...
						startActivity(i);
						break;
					case 1: //RESULTADOS AUDIOLOGICOS
						i = new Intent(getApplicationContext(),
								NewZp07bInfantAudioResultsActivity.class);
						...
						startActivity(i);
						break;
					case 2: //RESULTADOS AUDIOLOGICOS
						i = new Intent(getApplicationContext(),
								NewZp07bInfantAudioResultsActivity.class);
						...
						startActivity(i);
						break;
					case 3: //RESULTADOS AUDIOLOGICOS
						i = new Intent(getApplicationContext(),
								NewZp07bInfantAudioResultsActivity.class);
		...
		//	private String eventoaFiltrar = null;
			...
			protected String doInBackground(String... values) {
				...
				try {
					...
					zp07b = zipA.getZp07bInfantAudioResults(filtro, MainDBConstants.recordId);
					zipA.close();
				} catch (Exception e) {
			...
			protected void onPostExecute(String resultado) {
				...
				gridView.setAdapter(new Infant07bVisitAdapter(getApplicationContext(), R.layout.menu_item_2, menu_infante_info,
						zp07b));
